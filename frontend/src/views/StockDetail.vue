    ...
    <div class="analysis-grid">
      ...
      <div class="analysis-card card">
        <div class="analysis-header" @click="showFund = !showFund">
          ...
          <div class="header-right">
            <button class="primary" @click.stop="analyze('fundamental')" :disabled="analyzing.fundamental">
      ...
      <div class="analysis-card card">
        <div class="analysis-header" @click="showTech = !showTech">
          ...
          <div class="header-right">
            <button class="primary" @click.stop="analyze('technical')" :disabled="analyzing.technical">
      ...
      <div class="price-marks">
        <div v-for="m in meta.price_marks" :key="m.id" class="price-mark">
          ...
          <span v-if="meta.last_price != null" :class="['mark-diff', diffClass(meta.last_price - m.price)]">
            ...
            ({{ meta.last_price >= m.price ? '+' : '' }}{{ ((meta.last_price - m.price) / m.price * 100).toFixed(1) }}%)
          </span>
          <button class="ghost" style="padding:2px 8px;font-size:12px" @click.stop="removeMark(m.id)">×</button>
        </div>
      </div>
...
// Fold state for the entire analysis card
